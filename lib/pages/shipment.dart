...
class Shipment extends StatefulWidget {
  ...
  @override
  ShipmentState createState() => ShipmentState();
}
...
class ShipmentState extends State<Shipment> {
  ...
  getShipments() async {
    ...
    nextPage ="${Api().baseUrl}${Api().apiUrl}/sell/?start_date=$date&shipping_status=$selectedStatus";
    generateShipmentList();
  }
...
// shipment block
  ...
  generateShipmentList() async {
    ...
    if (nextPage != null) {
      await dio.get(nextPage!).then((value) async {
