...
class CheckOutState extends State<CheckOut> {
  List<Map> removeDublicates(List<Map> items) {
    return items
        .map((item) => jsonEncode(item)) // Encode to JSON string for comparison
        .toSet() // Remove duplicates
        .map((item) => jsonDecode(item)) // Decode back to Map
        .toList().cast<Map>();
  }
                            ...
                            children: <Widget>[
                              ...
                              DropdownButtonHideUnderline(
                                child: DropdownButton<String>(
                                    ...
                                    //index['tax_rate_id'],
                                    items: removeDublicates(paymentMethods)
                            ...
                            children: <Widget>[
                              ...
                              DropdownButtonHideUnderline(
                                child: DropdownButton(
                                    ...
                                    //index['tax_rate_id'],
                                    items: removeDublicates(paymentAccounts)
